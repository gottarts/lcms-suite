...
- Le work archiviate non sono ancora visibili da nessuna UI — se serve consultarle si deve accedere al DB direttamente. Valutare se aggiungere un toggle "mostra archiviate" in WorkPage.
